...
CubeFactory* CubeFactory::m_Singleton = NULL;
CubeFactory::CubeFactory(VulkanApp* p_VulkanApp)
{
...
void CubeFactory::CreateGraphicsPipeline()
{
...
void CubeFactory::CreateVertexBuffer(const void * vertexData, uint32_t dataSize, uint32_t dataStride)
{
