...
RectangleInstancingScheme::~RectangleInstancingScheme()
{
    ...
    vkUnmapMemory(m_VulkanApplication->m_hDevice, m_DescriptorSet->UniformBuffer->m_BufObj.m_Memory);
    vkDestroyBuffer(m_VulkanApplication->m_hDevice, m_DescriptorSet->UniformBuffer->m_BufObj.m_Buffer, NULL);
    vkFreeMemory(m_VulkanApplication->m_hDevice, m_DescriptorSet->UniformBuffer->m_BufObj.m_Memory, NULL);
}
