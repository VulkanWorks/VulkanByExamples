...
void UIDemo::Grid(Scene* p_Scene, int p_Width, int p_Height)
{
    ...
    for (int i = 0; i < parentCol; i++)
    {
        for (int j = 0; j < parentRow; j++)
        {
            ...
            Node* m_Parent = new Rectangl(p_Scene, NULL, BoundingRegion((i * parentColWidth), (j * parentColHeight), parentColWidth - 2, parentColHeight), name, (useMultiDraw ? SHAPE::SHAPE_RECTANGLE_MULTIDRAW : SHAPE::SHAPE_RECTANGLE_INSTANCED));
...
//    this->SetZOrder(20);
    ...
    Rectangl* background = new Rectangl(p_Scene, this, bgDim, "", (useMultiDraw ? SHAPE::SHAPE_RECTANGLE_MULTIDRAW : SHAPE::SHAPE_RECTANGLE_INSTANCED));
    ...
    bar = new Rectangl(p_Scene, background, barDim, "Bar", (useMultiDraw ? SHAPE::SHAPE_RECTANGLE_MULTIDRAW : SHAPE::SHAPE_RECTANGLE_INSTANCED));
    ...
    progressIndicator = new Rectangl(p_Scene, bar, piDim, "ProgressIndicator", (useMultiDraw ? SHAPE::SHAPE_RECTANGLE_MULTIDRAW : SHAPE::SHAPE_RECTANGLE_INSTANCED));
