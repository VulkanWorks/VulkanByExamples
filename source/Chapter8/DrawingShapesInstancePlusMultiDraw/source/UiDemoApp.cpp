...
//    Node* m_Parent = new Rectangl(m_Scene, NULL, BoundingRegion(30, 30, 200, 200), "Node 1", SHAPE::SHAPE_RECTANGLE_INSTANCED);
//    m_Parent->SetColor(glm::vec4(1.0, 0.0, 0.0, 1.0));
//    m_Parent->SetDefaultColor(glm::vec4(1.0, 0.0, 0.0, 1.0));
//    m_Parent->SetMemPoolIdx(0);
//    m_Parent->SetZOrder(90000);

//    Node* m_Parent1 = new Rectangl(m_Scene, NULL, BoundingRegion(150, 150, 200, 200), "Node 2", SHAPE::SHAPE_RECTANGLE_INSTANCED);
//    m_Parent1->SetColor(glm::vec4(0.0, 1.0, 0.0, 1.0));
//    m_Parent1->SetDefaultColor(glm::vec4(0.0, 1.0, 0.0, 1.0));
//    m_Parent1->SetMemPoolIdx(0);
//    m_Parent1->SetZOrder(100000);
